//get lga input value
    ...
    //get geojson polygon
    //get lga statistics
        //create lga statistics popup information

    //get venue information
        //create venue statistics popup information

    //get map parameters

        //create base map canvas
            //add lga-level information to the map
            //add venue-level information to the map


// notes
// - may need to prevent a refresh on submission of the search input-form
...
async function loadLgaPolygon(lgaIds) {
    ...
    const url = '/prototype-html-css-js/resources/geoJSON/'+lgaIds+'.geojson';
...
async function createLgaPopupInformation(lgaIds) {
    //build url for fetching;
    const url = '/prototype-html-css-js/resources/statistics/'+lgaIds+'-stats.json';
...
async function loadVenueInformation (lgaIds) {
    ...
    const url='/prototype-html-css-js/resources/premises/'+lgaIds+'-venues.json';
